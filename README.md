...
6. `wordcloud.png`  
   Imagem PNG da nuvem de palavras para visualização imediata.
...
> Por padrão a imagem é salva como `wordcloud.png` dentro da pasta de output.
...
- `--wordcloud-png` (padrão `wordcloud.png`): nome do arquivo PNG da nuvem
...
- `wordcloud.png` para visualização rápida da nuvem de palavras.
